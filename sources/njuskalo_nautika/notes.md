# Njuškalo Nautika Notes

- Public domain assumption for probing: `https://www.njuskalo.hr`
- Probe uses broad nautical/public classified pages only.
- Latest result: `candidate_requires_rendering_for_detail_links`
